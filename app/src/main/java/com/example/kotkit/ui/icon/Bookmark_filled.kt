...
public val Bookmark_filled: ImageVector
    get() {
        if (_Bookmark_filled != null) {
            return _Bookmark_filled!!
        }
        _Bookmark_filled = ImageVector.Builder(
            ...
            path(
                fill = SolidColor(Color(0xFF0F172A)),  // Thêm fill color
                fillAlpha = 1.0f,
...
private var _Bookmark_filled: ImageVector? = null